    ...
    <div class="container">
        ...
        <div class="controls-bar">
            <div class="tabs-container">
                <button class="tab-btn active" onclick="filterTableType('ALL', this)"><i class="fa-solid fa-layer-group"></i> All Records</button>
                <button class="tab-btn" onclick="filterTableType('mc', this)"><i class="fa-solid fa-file-medical"></i> MC Documents</button>
                <button class="tab-btn" onclick="filterTableType('timeslip', this)"><i class="fa-solid fa-clock"></i> Time Slips</button>
            </div>
        </div>
                ...
                <tbody>
                    <?php if ($result && $result->num_rows > 0): ?>
                        <?php while($row = $result->fetch_assoc()): 
                            ...
                            $isMC = ($row['documentType'] === 'mc');
                            $typeClass = $isMC ? 'type-mc' : 'type-ts';
                            $typeIcon = $isMC ? 'fa-file-medical' : 'fa-clock';
                        ?>
                        <tr class="doc-row" data-type="<?php echo $row['documentType']; ?>">
                            <td>
